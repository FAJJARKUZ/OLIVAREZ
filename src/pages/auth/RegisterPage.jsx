  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
        <div className="rounded-2xl bg-white shadow-sm border border-neutral-100 p-8 text-center max-w-md">
          <p className="text-olive-600 font-medium">Account created. Check your email to confirm. Redirecting to login...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="rounded-2xl bg-white shadow-sm border border-neutral-100 p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-olive-800">Create account</h1>
            <p className="text-neutral-500 mt-1">Olivarez College Inventory</p>
          </div>
