...
export function FinancesPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-neutral-800">Finances</h1>
      <p className="text-neutral-500">Invoices and payment status (Supplier).</p>
      ...
      <Card>
        ...
        {loading ? (
          ...
          <p className="text-neutral-500">No invoices. Table supplier_invoices can be added in Supabase.</p>
        ) : (
